...
import { analysisBatchesTable, analysisBudgetWindows, analysisReservations, analysisRuns, guides, guideSteps } from "../src/processor/db/schema.js";
...
test("funding migration preserves accounting independently of guide cascades", async () => {
  ...
  const migration = await readFile("drizzle/0003_analysis_funding.sql", "utf8");
