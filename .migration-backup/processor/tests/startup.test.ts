...
import { DELETION_PENDING_ACTIVE, UPLOAD_CANCELLATION_TOMBSTONE } from "../src/asset-lifecycle.js";

process.env.NODE_ENV = "test";
const { cleanupLocalProcessingResidue, cleanupPrivateAssetLifecycle, verifyStorage, withStartupTimeout } = await import("../src/index.js");
