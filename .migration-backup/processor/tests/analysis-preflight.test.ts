...
import { inspectAnalysisPreflight, formatAnalysisPreflight, preflightOutputMode } from "../src/analysis-preflight.js";
import { verifyAnalysisReadiness } from "../src/analysis-admission.js";
import { GEMINI_TEST_MODEL, GEMINI_PROMPT_VERSION } from "../src/gemini/request.js";
...
test("standalone CLI is safe even with production flags, invalid server config and unreachable database", () => {
  const result = spawnSync(process.execPath, ["--import", "tsx", resolve("processor/src/analysis-preflight.ts"), "--json"], {
