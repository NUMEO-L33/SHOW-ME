...
import { AnalysisAccountingError } from "../src/analysis-accounting-contract.js";
...
import { AnalysisWorkError, type AnalysisWorkClaim } from "../src/analysis-work.js";
import { analysisAccountingControls, analysisBudgetWindows, analysisRequestAttempts, analysisRuns, guides } from "../src/db/schema.js";
...
test("queue migration backfills existing payloads before enforcing projections without deleting or resetting them", async () => {
  const migration = await readFile("processor/drizzle/0005_analysis_work_queue.sql", "utf8");
