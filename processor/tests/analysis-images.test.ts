...
import { analysisManifest, ANALYSIS_LIMITS } from "../src/analysis-contract.js";
import { AnalysisImageError, createPrivateAnalysisImageLoader, type ApprovedSyntheticImages } from "../src/analysis-images.js";
import { attemptFrameObjectKey } from "../src/asset-lifecycle.js";
...
test("private image reader remains absent from startup and HTTP registration", async () => {
  for (const path of ["processor/src/index.ts", "processor/src/server.ts"]) {
