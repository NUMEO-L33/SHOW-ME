...
import { DurableAnalysisAdmission, AnalysisAdmissionError, type AnalysisAdmissionInput, type AnalysisAdmissionSnapshot, type AnalysisSpendingPolicy } from "../src/analysis-admission.js";
import type { AnalysisAdmission, AnalysisRequestCommand } from "../src/analysis-api.js";
...
import { analysisAccountingControls, analysisBudgetWindows, analysisRuns, guides } from "../src/db/schema.js";
import { emptyFundingLedger } from "../src/analysis-funding.js";
...
async function harness(context: TestContext) {
  ...
  const snapshot: AnalysisAdmissionSnapshot = {
    ...
    runtime: { repository: "postgres-0005", dispatcher: "durable-accounted-v1", inputTokenBound: 1000, boundIncludes: "prompt-schema-targets-context" },
