...
import { type AnalysisBatchCompletion } from "../src/analysis-batch-completion.js";
...
import { analysisAccountingControls, analysisBatchesTable, analysisBudgetWindows, analysisRequestAttempts, analysisRuns, guideDrafts, guides } from "../src/db/schema.js";
...
test("batch status migration backfills prior payloads without resetting results or deleting accounting", async () => {
  const sql = await readFile("processor/drizzle/0006_analysis_batch_completion.sql", "utf8");
